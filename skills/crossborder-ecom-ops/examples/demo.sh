#!/usr/bin/env bash
# 端到端演示：把五个脚本各跑一次，结果写到 examples/out/
#
...
echo "[1/5] 费率核算与扣费风险标记 -> out/fee.csv"
...
echo "[2/5] 表格清洗与结构化 -> out/clean.csv"
...
echo "[3/5] 选品利润测算（五国站点） -> out/selection.md"
...
for stage in ["fee", "clean", "selection", "PO", "review"]:
